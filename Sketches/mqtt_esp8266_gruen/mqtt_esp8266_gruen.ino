...
#define ESPHostname "ESP8266_MQTT_Test_gruen" 
String clientId = "ESP8266-gruen";      

#define outTopic "esp8266gruen/outtopic" 
#define inTopic "esp8266gruen/intopic"
...
void loop() {  
  ...
  if (buttonState != lastButtonState) {
    if (buttonState == HIGH) {
      client.publish("esp8266gruen/outtopic", "OFF"); 
      Serial.print("Changing Button to OFF\n");
      client.publish("esp8266gelb/intopic", "OFF");
    } else {
      client.publish("esp8266gruen/outtopic", "ON");
      Serial.print("Changing Button to ON\n");
      client.publish("esp8266gelb/intopic", "ON");
    }
